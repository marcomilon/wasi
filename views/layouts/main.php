        ...
        <div class="row h-100">
            <div class="col-md-2 menu">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link menu__link <?=  stripos($_GET['r'], 'form') !== false ? 'menu__link--active' : '' ?>" href="index.php?r=form/default/index"><i class="far fa-list-alt"></i> Elements</a>
                    ...
                    <a class="nav-link menu__link <?= stripos($_GET['r'], 'document') !== false ? 'menu__link--active' : '' ?>" href="index.php?r=document/default/index"><i class="fas fa-cubes"></i> Blocks</a>
                </nav>
            </div>
            <div class="col-md-10">
                <?= $content ?>
